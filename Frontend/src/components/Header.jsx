          ...
          sticky
            ...
            <div className="navbar">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    ...
                    <li><Link className=" dark:text-black" to='/'>Home</Link></li>
                    <li><Link className=" dark:text-black" to='/about'>About</Link></li>
                    <li><Link className=" dark:text-black" to='/course'>Store</Link></li>
                    <li><Link className=" dark:text-black" to='/contact'>Contact</Link></li>
                    <li><Link className=" dark:text-black" to='/cart'>Cart({cartItems.length})</Link></li>
                    </ul>
                </div>
                <a href="/" className="text-3xl font-bold cursor-pointer">book<span className='text-pink-400'>Store</span></a>
                </div>
                    ...
                    <div className="navbar-center hidden lg:flex">
                        ...
                        <li><Link className="dark:text-white dark:hover:text-slate-800" to='/'>Home</Link></li>
                    <li><Link className="dark:text-white dark:hover:text-slate-800" to='/about'>About</Link></li>
                    <li><Link className="dark:text-white dark:hover:text-slate-800" to='/course'>Store</Link></li>
                    <li><Link className="dark:text-white dark:hover:text-slate-800" to='/contact'>Contact</Link></li>
                    <li><Link className="dark:text-white dark:hover:text-slate-800" to='/cart'>Cart({cartItems.length})</Link></li>
                        </ul>
                    </div>
